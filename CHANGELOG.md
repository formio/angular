...
## [Unreleased: 5.2.13-rc.2]
### Changed
 - FIO-8009: Update 5.2.x formiojs@4.19.2-rc.1
...
## 5.2.3-rc.4
### Changed
 - FIO-5172: Fixes validation errors shown on form load in formmanager and pro.formview.io
